...
import { getInterCityBusEst } from "@/server_action/InterCity/getInterCityBusEst";
...
export default function Bus({
    ...
    const busEst = useQuery({
        queryKey: ["busEst"],
        queryFn: () => getInterCityBusEst(bus),
        enabled: !!bus,
                            ...
                            <div className="w-full flex flex-col">
                                ...
                                {data.map((d) => {
                                    return d.SubRoutes.map((item) => {
                                        return (
                                            <Fragment
                                                key={`fragment ${item.SubRouteName.Zh_tw} ${item.Direction} ${item.Headsign}`}
                                            >
